...
routes.get("/", (0, authGuard_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN), doctors_controller_1.doctorController.getAllDoctor);
routes.get("/:id", (0, authGuard_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN), doctors_controller_1.doctorController.getSingleDoctor);
